...
Voici le Markdown **complet et exactement structuré** selon le modèle de ton cours/dépôt.

Il inclut :

1. L'en-tête d'équipe avec ton nom.
2. L'Exercice 1 avec la table et les noms exacts de tes images.
3. L'Exercice 2 complet avec les explications `assertThrows` et la configuration des tests paramétrés JUnit.

Tu n'as plus qu'à tout copier-coller dans ton fichier **`README.md`** :

```markdown
Team:
  Clark Tahe - [Ton Numéro d'Étudiant]
  [Nom du coéquipier] - [Numéro d'étudiant du coéquipier]
